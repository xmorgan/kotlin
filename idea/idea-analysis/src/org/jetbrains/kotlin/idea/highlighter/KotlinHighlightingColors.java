...
public class KotlinHighlightingColors {
    ...
    public static final TextAttributesKey UNRESOLVED_SUPPRESSED = createTextAttributesKey("KOTLIN_UNRESOLVED_SUPPRESSED", DefaultLanguageHighlighterColors.IDENTIFIER);
