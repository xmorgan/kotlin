...
public class DiagnosticsTestWithOldJvmBackendGenerated extends AbstractDiagnosticsTestWithOldJvmBackend {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class JvmDefaults extends AbstractDiagnosticsTestWithOldJvmBackend {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM_OLD, testDataFilePath);
        }

        public void testAllFilesPresentInJvmDefaults() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/diagnostics/testsWithJvmBackend/jvmDefaults"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM_OLD, true);
        }

        @TestMetadata("compiler/testData/diagnostics/testsWithJvmBackend/jvmDefaults/allCompatibility")
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class AllCompatibility extends AbstractDiagnosticsTestWithOldJvmBackend {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM_OLD, testDataFilePath);
            }

            public void testAllFilesPresentInAllCompatibility() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/diagnostics/testsWithJvmBackend/jvmDefaults/allCompatibility"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM_OLD, true);
            }
