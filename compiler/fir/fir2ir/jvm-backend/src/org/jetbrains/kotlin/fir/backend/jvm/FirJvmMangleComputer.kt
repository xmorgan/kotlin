...
class FirJvmMangleComputer(
    ...
    private fun FirFunction<*>.platformSpecificFunctionName(): String? = null

    private fun FirFunction<*>.specialValueParamPrefix(param: FirValueParameter): String = ""
...
//    override fun visitTypeParameter(typeParameter: FirTypeParameter, data: Boolean) {
//        typeParameter.effectiveParent().accept(this, data)
//
//        builder.appendSignature(MangleConstant.TYPE_PARAM_INDEX_PREFIX)
//        builder.appendSignature(typeParameter.index)
//    }
